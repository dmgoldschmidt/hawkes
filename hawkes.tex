...
\begin{equation}\label{N_hat}
  \hat{n}(t_0,t_1) := \int_{t_0}^{t_1}\lambda(t)dt = \frac{\sigma}{\rho}e^{-\rho{t_0}}(1 - e^{-\rho(t_1-t_0)}),
\end{equation}
...
in the interval $(t_j,t_i]$, which is  given by \eqref{N_hat}.  Thus, \eqref{p_ij} becomes
