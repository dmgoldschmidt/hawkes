...
$$
then we solve the constrained maximization problem using a lagrange multiplier $\nu$ just as we did above.  Define
$$
W'_0 := \sum_{i=1}^N\omega'_{i0},\quad\text{and}\quad W'_1 :=
\sum_{i>j>0}\omega'_{ij}.
$$
...
\begin{equation}\label{eq1}
  \begin{split}
    ...
    \lambda_0 &= 2\nu\frac{t_{N0}}{\sum_{i=1}^N\omega'_{i0}},
  \end{split}
\end{equation}
...
\begin{equation}\label{eq2}
  \begin{split}
    ...
    \nu\sum_{j=0}^{N-1}\k_{ij}\quad\text{whence} \\
    \sigma &= 2\nu\frac{\sum_{j=0}^{N-1}\k_{ij}}{\sum_{i>j>0}\omega'_{ij}}.
  \end{split}
\end{equation}
